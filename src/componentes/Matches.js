          ...
          <div className = "contenedorMatches">
              <ul className="myrythm list-unstyled row">
                  <button className="botonImpostaciones">
                   <li className="col-4 "><FaCog className="icono"/></li>
                  </button>
                  <li className="logo col-4"><strong>MyR</strong></li>
                  <button className="botonChat">
                  <li className="col-4"><FaComments className="icono"/></li>
                  </button>
              </ul>
              <div className="contenedorParejas row">
                ...
                <ul className="contenedorIformaciones list-unstyled">
                    <li className="row">
                     <p className="col-12 nombre"><strong>Nombre, edad</strong></p>
                    </li>
                    <li className="row">
